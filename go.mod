module github.com/micro-eshop/catalog
...
require (
	...
	github.com/dominikus1993/integrationtestcontainers-go v0.0.3 // indirect
	...
	github.com/micro-eshop/common-go v0.0.5 // indirect
